...
const paymentList = ['신용/체크카드', '현대카드', '네이버페이', '토스', '페이코', '카카오페이', '삼성 페이', 'SSG 페이', '휴대폰결제', '실시간계좌이체'];
    ...
    <OrderWrapper>
      <OrderInfoWrapper>
        <Info>
          ...
          <CheckAuthentication>
            <div>
              정확한 주문자 정보 확인을 위해 <br></br>주문 시 최초 1회 본인인증이 필요합니다.
            </div>
        ...
        <div>
          ...
          <div>
            ...
            <div>
              ...
              <EssentialName>
                <div>수령인<span>*</span></div>
                <Input></Input>
              </EssentialName>
              <EssentialName>
                <div>배송지<span>*</span></div>
                <SearchWrapper>
                  <InputWrapper>
              ...
              <ShippingDetail>
                ...
                <div>
                  - 도서산간 지역의 경우 추후 수령 시 추가 배송비가 발생할 수 있으며, 해외배송은 불가합니다.<br></br>
                  - 배송지 불분명 및 수신불가 연락처 기입으로 반송되는 왕복 택배 비용은 구매자 부담으로 정확한 주소 및 통화 가능한 연락처 필수 기입.<br></br>
                  - 대리 주문으로 해외 주소로 발송 전, 주문품 꼭 확인해주세요. 오배송 및 불량 교환에 따른 배송비는 국내 택배 비용만 지원됩니다.
                </div>
              </ShippingDetail>
            </div>
          </div>
            ...
            <CouponDetail>
              ...
              <form>
                <select name='couponSelect'>
                  ...
                  <option value='1'>GREEN 회원 16% 특별쿠폰 / 최대 5만원 할인 / ~ 2020년 12월 31일 23:59분 까지</option>
                  <option value='2'>만나서 반가워요! 10% 쿠폰 / 최대 1만원 할인 / ~ 2020년 12월 30일 14:00분 까지</option>
                </select>
              </form>
            </CouponDetail>
            <CouponDetail>
            ...
            <Mileage>
              ...
              <SearchWrapper>
                <InputWrapper>
                  ...
                  <p>보유 마일리지 0<span>p</span></p>
                </InputWrapper>
              </SearchWrapper>
            </Mileage>
            <EtcDetail>
              - 할인쿠폰 제외 상품이 포함되어 있는 경우, 해당 제품을 제외하고 할인이 적용됩니다.<br></br>
              - 브랜드쿠폰과 보너스쿠폰은 중복사용이 불가능합니다.<br></br>
              - 일부 상품(할인쿠폰제외상품)에는 보너스쿠폰이 적용되지 않습니다.<br></br>
              - 쿠폰에 따라 최대 쿠폰 사용 금액이 제한될 수 있습니다.<br></br>
            </EtcDetail>
          </CouponForm>
        </Info>
        <CheckOutInfo>
        ...
        <CheckOutEtc>
          ...
          <p>
            ...
            국내 모든 카드 사용이 가능하며 해외에서 발행된 카드는 이용하실수 없습니다. (해외배송은 불가능합니다)<br></br>
            금요일 오후 6시~ 일요일 주문은 결제 완료 후 취소 요청시 고객센터 > 주문취소를 이용하시면 됩니다.<br></br>
          </p>
          <label>공인인증서 안내</label> &nbsp; &nbsp; &nbsp; &nbsp;<label>안심클릭 의무 사용</label>
        </CheckOutEtc>
      </OrderInfoWrapper>
      <OrderCommodity>
        <OrderCommodityTitle>
          ...
          <TotalPrice>
            ...
            <div>
              ...
              <label
                for='cb3'
              >
                주문하실 상품 및 결제, 주문정보 확인하였으며, 이에 동의합니다. (필수) 
              </label>
            </div>
